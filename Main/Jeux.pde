...
public class Jeux extends PApplet  {
  ...
  void draw() {
    ...
    switch (state) {
      ...
      case 3:
        ...
        image(jeux3, 60, 420, 280, 180); // Image aux coordonnées (60, 60) et dimensions 280x180
        if(rick == 1){
          background(255);
          image(gif, 45, 100); // Afficher le GIF à la position (0, 0)
        }
      ...
      case 4:
        ...
        image(jeux4, 60, 420, 280, 180); // Image aux coordonnées (60, 60) et dimensions 280x180
        if(rick == 1){
          background(255);
          image(gif, 45, 100); // Afficher le GIF à la position (0, 0)
        }
      ...
      case 5:
        ...
        image(jeux5, 60, 420, 280, 180); // Image aux coordonnées (60, 60) et dimensions 280x180
        if(rick == 1){
          background(255);
          image(gif, 45, 100); // Afficher le GIF à la position (0, 0)
        }
      ...
      case 6:
        ...
        image(jeux6, 60, 420, 280, 180); // Image aux coordonnées (60, 60) et dimensions 280x180
        if(rick == 1){
          background(255);
          image(gif, 45, 100); // Afficher le GIF à la position (0, 0)
        }
      ...
      case 7:
        ...
        image(jeux7, 60, 420, 280, 180); // Image aux coordonnées (60, 60) et dimensions 280x180
        if(rick == 1){
          background(255);
          image(gif, 45, 100); // Afficher le GIF à la position (0, 0)
        }
      ...
      case 8:
        ...
        image(jeux8, 60, 420, 280, 180); // Image aux coordonnées (60, 60) et dimensions 280x180
        if(rick == 1){
          background(255);
          image(gif, 45, 100); // Afficher le GIF à la position (0, 0)
        }
