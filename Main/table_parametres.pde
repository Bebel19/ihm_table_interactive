...
public class FenetreParametres extends PApplet {
    // Configuration initiale de la fenêtre
    public void settings() {
        size(400, 300); // Taille de la fenêtre de paramètres
    }

    public void setup(){
        size(720,900); 
        image_parametres = loadImage("./Images/retour.png");
  ...
  image(image_parametres, 40,40, 50, 50); 
